...
const CATEGORIES = [
  {
    ...
    items: ['Agile / Scrum Masters', 'Product Managers', 'Program & Project Managers', 'Enterprise Architects', 'Business Analysts', 'Systems Analysts'],
  },
  {
    title: 'Application Development - Java Platform',
    items: ['Architects', 'UI Designers & Developers', 'Java Programmers', 'Full Stack Developers', 'DevOps Engineers', 'Machine Learning Specialists'],
  },
  {
    title: 'Application Development - Microsoft Platform',
    items: ['Architects', 'UI Designers & Developers', 'Java Programmers', 'Full Stack Developers', 'DevOps Engineers', 'Machine Learning Specialists'],
  },
  {
    title: 'Data Management & Analytics',
    items: ['Data Architects', 'Data Engineers', 'ETL Experts', 'Data Scientists', 'Analytics / Reporting Specialists', 'Data Visualization Experts'],
  },
  {
    title: 'Cloud, Cybersecurity & Infrastructure Services',
    items: ['Network Engineers', 'System Engineers', 'Security Engineers', 'Cloud Architecture, Migration & Support', 'Virtualization Engineers', 'Data Center Operators', 'End User Support'],
  },
  {
    title: 'Domain Driver Testing',
    items: ['Compliance Engineers', 'Performance Engineers', 'Automation Experts', 'Domain-specific Testers', 'Tool-specific Testers'],
  },
  {
    title: 'Platforms & Packages',
    items: ['SAP Hana', 'Oracle Applications', 'SalesForce Platform', 'Microsoft Platform', 'Java Platform', 'iOS Platform', 'Android Platform', 'AWS Cloud', 'Azure Cloud'],
  },
  {
    title: 'User Experience',
    items: ['Creative Directors', 'Art Directors', 'UX Experts', 'UI Researchers', 'UI Designers', 'Usability Testers'],
  },
  {
    title: 'Hardware Engineering',
    items: ['Digital / Analog / Mixed Signal Engineers', 'Physical Designers', 'Verification Engineers', 'RFL Developers', 'Post Silicon Validation Engineers', 'Layout Specialists'],
  },
  {
    title: 'Embedded Software Engineering',
    items: ['Middleware Framework (UI, Multimedia, Networking, DRM, Security, Radio Interface)', 'System Libraries & Stacks', 'Linux Kernels & Device Drivers', 'Hardware Abstraction Engine', 'Application Processor, Model & DSP'],
  },
  {
    title: 'Niche Skills',
    items: ['Blockchain', 'IoT', 'Data Science', 'Machine Learning', 'Robotic Process Automation', 'Augmented Reality', 'Microservices Architecture'],
  },
];
...
const CONTINGENT_SERVICES = [
  {
    ...
    desc: 'We find the hottest and technical contingent experts for you to supplement your core teams.',
  },
  {
    icon: ICONS.payroll,
    title: 'Payroll',
...
const PERM_SERVICES = [
  {
    icon: ICONS.search,
    title: 'Search',
    desc: 'Leveraging our talent networks, domain/functional expertise, and your employer brand, we find that "purple squirrel" for you to hire full-time.',
  },
  {
    icon: ICONS.rpo,
    title: 'RPO',
...
export default function TechStaffing() {
