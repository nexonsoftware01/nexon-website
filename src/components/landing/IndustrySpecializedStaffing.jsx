...
const CATEGORIES = [
  {
    title: 'Life Sciences',
    items: ['Pre-clinical / Scientific', 'Clinical Research FSP Services', 'Engineering & Validation', 'Manufacturing', 'Information Technology'],
  },
  {
    title: 'Insurance',
    items: ['Finance', 'Actuarial', 'Claims', 'Compliance', 'Marketing', 'Underwriting', 'Operations / Call Center'],
  },
  {
    title: 'Banking',
    items: ['Research & Analytics', 'Trade Management', 'Risk & Compliance', 'Client Services & Reporting', 'Custodian Services', 'Clearing & Settlement'],
  },
  {
    title: 'Semiconductor',
    items: ['Hardware Engineering – Physical Design', 'Hardware Engineering – Verification', 'Hardware Engineering – RTL', 'Hardware Engineering – Post Silicon Validation', 'Analog & Mixed Signal Layout', 'Embedded Software Development – Multiple Platforms', 'RF Engineering'],
  },
  {
    title: 'Automotive',
    items: ['Mechanical Engineering', 'Electrical Engineering', 'Autosar', 'HMI', 'MBD', 'Verification & Validation'],
  },
  {
    title: 'Healthcare Payer',
    items: ['Underwriter Management', 'Medical Management / HEDIS', 'Claims Management', 'Business Process Automation', 'Seasonal Enrollment / Call Center'],
  },
  {
    title: 'Oil & Gas',
    items: ['Geophysicists', 'Environmental Engineers', 'Drilling Engineers', 'Safety Engineers', 'Production Engineers', 'Marine Engineers', 'Sub Sea Engineers', 'QA/QC & HSE Engineers'],
  },
];
...
const CONTINGENT_SERVICES = [
  {
    ...
    desc: 'We find the industry/domain specialized professional contingent experts for you to supplement your core teams.',
  },
  {
    icon: ICONS.payroll,
    title: 'Payroll',
...
export default function IndustrySpecializedStaffing() {
