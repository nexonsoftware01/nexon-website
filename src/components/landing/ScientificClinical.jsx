...
const CATEGORIES = [
  {
    title: 'Scientific',
    items: ['Biologist', 'Research Associate', 'Scientist', 'Lab Technician', 'Quality Assurance Associate', 'Quality Control Associate', 'Microbiologist', 'Medical Technologist', 'Chemist', 'Manufacturing & Operations', 'Packaging'],
  },
  {
    title: 'Clinical Research',
    items: ['Clinical Operations', 'Clinical Program Management', 'Study Management', 'Clinical Monitoring', 'Statistical Programming', 'Biostatistics', 'Clinical Data Management', 'Regulatory Affairs', 'Medical Science Liaisons', 'Physicians and Medical Monitors', 'Drug Safety', 'Medical Writing'],
  },
];
...
const CONTINGENT_SERVICES = [
  {
    ...
    desc: 'We find the most qualified scientific and clinical contingent experts for you to supplement your core teams.',
  },
  {
    icon: ICONS.payroll,
    title: 'Payroll',
...
const PERM_SERVICES = [
  {
    icon: ICONS.search,
    title: 'Search',
    desc: 'Leveraging our talent networks, domain/functional expertise, and your employer brand, we find that perfect scientific and clinical talent for you to hire full-time.',
  },
  {
    icon: ICONS.rpo,
    title: 'RPO',
...
export default function ScientificClinical() {
